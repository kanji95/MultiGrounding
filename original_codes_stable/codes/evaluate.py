...
#geval = gnet_evaluator(gpu='0,1', ckpt_path=ckpt_path, data_path=path_dict,
#                       gnet_config=gnet_config, query_level='referral')
geval = gnet_evaluator(gpu='0', ckpt_path=ckpt_path, data_path=path_dict, query_level='referral')
